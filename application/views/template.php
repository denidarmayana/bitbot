...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title><?=$title ?> | BitBot Crypoto Trading Bot</title>
	<!-- FAVICONS ICON -->
		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a  href="<?=base_url('trading') ?>" aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<g opacity="0.5">
							...
							<span class="nav-text">Trading Board</span>
						</a>
					</li>
					<li><a  href="<?=base_url('wallet') ?>" aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<g opacity="0.5">
